...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Lister tous les professeurs' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Liste des professeurs récupérée' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Récupérer un professeur par ID' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)(roles_enum_1.Role.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: 'Modifier un professeur' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(roles_enum_1.Role.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: 'Assigner une matière à un professeur' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(roles_enum_1.Role.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: "Retirer une matière d'un professeur" }),
