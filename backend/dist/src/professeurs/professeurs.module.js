...
const professeurs_controller_1 = require("./professeurs.controller");
...
exports.ProfesseursModule = ProfesseursModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [professeurs_controller_1.ProfesseursController],
        providers: [professeurs_service_1.ProfesseursService],
