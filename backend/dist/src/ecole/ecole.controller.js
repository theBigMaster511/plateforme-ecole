...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Créer l'école (une seule autorisée)" }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'École créée avec succès' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)(roles_enum_1.Role.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: "Modifier l'école" }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'École mise à jour avec succès' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(roles_enum_1.Role.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: "Supprimer l'école" }),
